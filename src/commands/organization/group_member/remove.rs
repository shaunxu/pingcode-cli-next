...
/// 在团队中移除一个成员：`DELETE /v1/directory/user_groups/{user_group_id}/members/{member_id}`
/// （scope: `pcp:write:global:team`）。
///
/// 仅解除成员与团队的关联，不删除用户本身；返回被移除的成员对象。
///
/// 文档：https://developer.alpha.pingcode.live/restapi/pingcode/deleteDirectoryUserGroupsByUserGroupIdMembersByMemberId
