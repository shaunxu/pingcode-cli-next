...
/// `pc ship ticket-property-plan list-properties` 的参数。
#[derive(Debug, Args)]
...
/// 获取工单属性方案中的属性列表：`GET /v1/ship/ticket_property_plans/{property_plan_id}/ticket_properties`
/// （分页，scope: `pcp:read:ship:configuration`）。
///
/// 文档：https://developer.alpha.pingcode.live/restapi/pingcode/getShipTicketPropertyPlansByPropertyPlanIdTicketProperties
