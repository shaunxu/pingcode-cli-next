...
//!
//! 对应 `/v1/ship/idea_states` 与 `/v1/ship/idea/idea_states` 的 REST 接口。
//!
//! 新增操作（operation）：
...
pub enum IdeaStateCommand {
    ...
    /// List 需求状态 in a product (GET /v1/ship/idea/idea_states?product_id=...)
    ///
    /// Docs: https://developer.alpha.pingcode.live/restapi/pingcode/getShipIdeaIdeaStatesByProductId
