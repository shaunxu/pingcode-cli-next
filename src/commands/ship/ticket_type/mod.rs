...
pub enum TicketTypeCommand {
    ...
    List(ListArgs),
    /// List 工单类型 in a product (GET /v1/ship/ticket/ticket_types?product_id=...)
    ///
    /// Docs: https://developer.alpha.pingcode.live/restapi/pingcode/getShipTicketTicketTypesByProductId
