...
//!
//! 对应 `/v1/ship/idea/idea_plans` 的 REST 接口。产品模块/排期的全量结构与写操作
...
pub enum IdeaPlanCommand {
    /// List idea plans (requirement schedules) in a product (GET /v1/ship/idea/idea_plans?product_id=...)
    ///
    /// Docs: https://developer.alpha.pingcode.live/restapi/pingcode/getShipIdeaIdeaPlansByProductId
