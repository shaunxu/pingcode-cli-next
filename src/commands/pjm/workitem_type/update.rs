...
/// `pc pjm workitem-type update` 的参数。
#[derive(Debug, Args)]
...
/// 部分更新一个工作项类型：`PATCH /v1/pjm/workitem_types/{workitem_type_id}`
/// （scope: `pcp:write:pjm:configuration`）。
///
/// 属于「工作项配置」，完整请求字段见文档。
///
/// 文档：https://developer.alpha.pingcode.live/restapi/pingcode/patchPjmWorkitemTypesByWorkitemTypeId
